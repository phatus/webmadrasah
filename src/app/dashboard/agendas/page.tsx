...
import { getAgendas, deleteAgenda } from "@/actions/academic"
    ...
    return (
        <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default sm:px-7.5 xl:pb-1">
            ...
            <div className="flex flex-col">
                ...
                {agendas.map((agenda: any, key: number) => {
                    const isPast = new Date(agenda.date) < new Date(new Date().setHours(0, 0, 0, 0));
                    return (
                        <div
                            className={`grid grid-cols-4 ${key === agendas.length - 1
                                ? ""
                        ...
                        >
                            ...
                            <div className="flex items-center justify-center p-2.5 xl:p-5">
                                <span className={`px-3 py-1 rounded-full text-xs font-semibold ${isPast ? 'bg-orange-100 text-orange-700' : 'bg-green-100 text-green-700'}`}>
