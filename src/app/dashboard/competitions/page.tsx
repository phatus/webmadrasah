...
import { getCompetitions, deleteCompetition } from "@/actions/competition"

export default async function DashboardCompetitions() {
    ...
    return (
        <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default sm:px-7.5 xl:pb-1">
            ...
            <div className="flex flex-col">
                ...
                {competitions.map((comp: any, key: number) => (
                    <div
                        className={`grid grid-cols-5 ${key === competitions.length - 1
                            ? ""
                    ...
                    >
                        <div className="flex items-center p-2.5 xl:p-5 col-span-2">
                            <div>
                                ...
                                <p className="text-xs text-gray-500">
                                    {new Date(comp.startDate).toLocaleDateString("id-ID")} - {new Date(comp.endDate).toLocaleDateString("id-ID")}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center justify-center p-2.5 xl:p-5">
                            <Link
                                href={`/dashboard/competitions/${comp.id}/submissions`}
                                className="text-emerald-600 font-bold hover:underline"
                            >
                                {comp._count.submissions} Peserta
                            </Link>
                        </div>

                        <div className="flex items-center justify-center p-2.5 xl:p-5">
                            <span className={`px-3 py-1 rounded-full text-xs font-semibold ${comp.isActive ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
                        ...
                        <div className="flex items-center justify-center p-2.5 xl:p-5 gap-3">
                            ...
                            >
                                ...
                                >
                                    ...
                                    />
                                    <path
                                        d="M9 11.3906C7.67812 11.3906 6.60938 10.3219 6.60938 9C6.60938 7.67813 7.67812 6.60938 9 6.60938C10.3219 6.60938 11.3906 7.67813 11.3906 9C11.3906 10.3219 10.3219 11.3906 9 11.3906ZM9 7.875C8.38125 7.875 7.875 8.38125 7.875 9C7.875 9.61875 8.38125 10.125 9 10.125C9.61875 10.125 9.61875 10.125 9 10.125C9 10.125 8.38125 9.61875 7.875 9C7.875 8.38125 8.38125 7.875 9 7.875Z"
                                        fill=""
                                    />
                                </svg>
                            </Link>
                            <form action={async () => {
                                ...
                                <button className="hover:text-red-600 transition-colors" title="Hapus Lomba">
                                    <svg
                                        className="fill-current"
                                        width="18"
                                        height="18"
