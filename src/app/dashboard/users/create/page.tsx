...
export default function CreateUserPage() {
    // @ts-ignore
    const [state, formAction] = useActionState(createUser, null as any)
    const [image, setImage] = useState("")

    return (
        <div className="max-w-4xl bg-white p-6 rounded shadow border border-stroke">
            <h1 className="text-2xl font-bold mb-6 text-black">Tambah User Baru</h1>
            ...
            <form action={formAction} className="space-y-6">
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-black mb-2">Username (untuk Login)</label>
                        <input
                            type="text"
                            name="username"
                            required
